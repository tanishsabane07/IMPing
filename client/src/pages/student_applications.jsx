...
//       try {
//         const response = await axios.get("http://localhost:3000/student/my-applications", {
//           headers: {
...
//               <div>
//                 <h2 className="text-lg font-semibold">{app.internshipId?.title || "Untitled Internship"}</h2>
//                 <p className="text-muted-foreground">{app.internshipId?.company}</p>
//                 <p className="text-sm mt-1">Status: <strong>{app.status}</strong></p>
//               </div>
...
//                   size="sm"
//                   variant="outline"
//                   onClick={() => navigate(`/internships/${app.internshipId?._id}`)}
//                 >
//                   View Internship
//                 </Button>
//               </div>
                ...
                <div className="flex flex-col justify-between">
                  ...
                  <div className="space-y-2">
                    ...
                    <Button
                      ...
                      onClick={() => window.open(`http://localhost:3000/${app.resume}`, '_blank')}
                    >
